...
\begin{frame}{MARL Systems: Learning Scheme}
	...
	\begin{exampleblock}{Decentralised Training and Distributed Execution (DTDE)}
		\begin{itemize}
...
\begin{frame}{MARL Systems: Learning Scheme}
	...
	\begin{exampleblock}{Centralised Training and Distributed Execution (CTDE)}
		\begin{itemize}
...
\begin{frame}{Learning in CAS: Toolkits}
	\begin{exampleblock}{MAgent~\footnote[frame]{zheng2018magent} \url{https://github.com/geek-ai/MAgent}}
		\begin{figure}
...
\begin{frame}{Learning in CAS: Can we use standard RL algorithms?}
	\begin{exampleblock}{In a centralised training decentralised execution settings}
		...
		\end{itemize}
	\end{exampleblock}
	\begin{exampleblock}{\emph{Indeed} yes \dots \href{}{}}
		\begin{itemize}
